...
import numpy as np
import os
from orc.utils.viz_utils import addViewerBox, applyViewerConfiguration
...
def display_disi_lab(simu):
    ...
    addViewerBox(simu.robot.viz, "world/table_box", table_size[0], table_size[1], table_size[2], table_color)
    applyViewerConfiguration(simu.robot.viz, "world/table_box", table_pos.tolist()+[0, 0, 0, 1])
    ...
    addViewerBox(simu.robot.viz, "world/backwall", backwall_size[0], backwall_size[1], backwall_size[2], backwall_color)
    applyViewerConfiguration(simu.robot.viz, "world/backwall", backwall_pos.tolist()+[0, 0, 0, 1])
    

def display_disi_lab_gepetto(simu):
    # display table and stuff
